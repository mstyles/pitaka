...
- `pub const MIN_SCORE: f32 = 0.60;` — results below it are dropped so "No results" stays meaningful. **Uncalibrated**: the spike's good hits ran 0.66–0.82 and its weakest kept hit was 0.703, but no nonsense query was measured. §8 adds that measurement and the constant moves to whatever it shows.
